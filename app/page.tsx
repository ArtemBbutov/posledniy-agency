  ...
  return <main id="top" className="backrooms-site authentic-backrooms story-site">
    ...
    <section className="cases-section" id="change">
      ...
      <div className="case-carousel" role="region" aria-roledescription="carousel" aria-label="Кейсы агентства" tabIndex={0}>
        ...
        <div className="case-pagination" aria-label="Выбор кейса">
          ...
          {cases.map((item,index)=><button type="button" key={item.n} data-case-index={index} aria-label={`Показать кейс ${item.title}`} aria-current={index === 0 ? "true" : undefined}/>)}
        </div>
    ...
    <section className="creators-strip" id="creators" aria-labelledby="creators-title">
      <header className="creators-strip-heading">
        ...
        <div><h2 id="creators-title">THE CREATORS</h2><p>2 основателя. Лично отвечаем за стратегию, контент и запуски.</p></div>
      </header>
      <div className="creators-people">
        <article className="creator-person">
          ...
          <div><small>CREATOR / 01</small><h3>Артём Бутов</h3><p>Основатель агентства</p></div>
        </article>
        <article className="creator-person">
          ...
          <div><small>CREATOR / 02</small><h3>Артём Федонко</h3><p>Основатель агентства</p></div>
        </article>
      </div>
    </section>
