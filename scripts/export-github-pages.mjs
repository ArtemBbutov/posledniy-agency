...
html = html
  ...
  .replaceAll('src="/creator-artem-butov-backrooms.png"', 'src="public/creator-artem-butov-backrooms.png"')
  .replaceAll('src="/creator-artem-fedonko-backrooms.png"', 'src="public/creator-artem-fedonko-backrooms.png"')
  .replaceAll('href="/creator-artem-butov-backrooms.png"', 'href="public/creator-artem-butov-backrooms.png"')
  .replaceAll('href="/creator-artem-fedonko-backrooms.png"', 'href="public/creator-artem-fedonko-backrooms.png"')
...
const revealTargets=[...document.querySelectorAll(['.story-scene header','.scene-notes article','.scene-conclusion','.cases-heading','.case-card','.work-story-copy > *','.work-story li','.system-map','.creators-strip-heading','.creator-person','.formats-story header > *','.brief-heading > *','.project-brief > *','.brief-level > footer'].join(','))];
