...
html = html.replaceAll("assets/index-fUwxV6Gh.css", "assets/index-BWLhCqJg.css");
html = html.replace(/<section class="transformation" id="change">[\s\S]*?<\/section><section class="work-story"/, `${cases}<section class="work-story"`);
